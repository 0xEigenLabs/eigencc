'''
[usage] python parse_cargo_package.py <cargo_toml_path> <tee_root>
...
def main():
    ...
    if len(sys.argv) < 3:
        err = "[usage] python {} cargo_toml_path tee_root".format(
            sys.argv[0])
    ...
    for pkg_path in members:
        pkg_toml_path = os.path.join(tee_root, pkg_path, "Cargo.toml")
