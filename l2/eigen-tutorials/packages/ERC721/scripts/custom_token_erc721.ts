...
const main = async () => {
    await depositETH721(bridge, l1TestWallet, l2TestWallet, utils.parseEther("1.0"))
    ...
    await wait(15000)
    await approveToken721(bridge, l1TestWallet, l2TestWallet, tokenPair.l1CustomToken, tokenId)
