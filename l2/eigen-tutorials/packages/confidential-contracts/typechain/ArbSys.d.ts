...
interface ArbSysInterface extends ethers.utils.Interface {
  functions: {
    ...
    "eigenCall(bytes)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "eigenCall", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getStorageAt",
    data: BytesLike
  ): Result;
...
export class ArbSys extends BaseContract {
  ...
  functions: {
    ...
    eigenCall(arg0: BytesLike, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    eigenCall(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
