...
import type {
  IArbTokenBridge,
  IArbTokenBridgeInterface,
} from "../IArbTokenBridge";
...
export class IArbTokenBridge__factory {
  ...
  static createInterface(): IArbTokenBridgeInterface {
    return new utils.Interface(_abi) as IArbTokenBridgeInterface;
  }
  static connect(
    address: string,
