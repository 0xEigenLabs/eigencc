...
exports.aes_enc = exports.aes_dec = exports.decrypt = exports.encrypt = void 0;
...
const encrypt = function (publicKey, message, options) {
    ...
    // d = MAC(Km; c || S2)
    const tag = macMessage(options.macName, macKey, Buffer.concat([bufCipherText, options.s2], bufCipherText.length + options.s2.length));
    // outputs R || c || d
